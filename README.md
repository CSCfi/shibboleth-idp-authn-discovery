...
### Version 2.1.0 and remembering user prior selection
Discovery can now be set to remember user prior selection bypassing Disco view. If you set java properties 
```
